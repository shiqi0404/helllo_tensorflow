...
# 评估(evaluation)模型
# 在 test_demo1_Gradient_Descent.py 中训练出方程
#              y = 2.98x + 2.07
...
# 前面我们构建了一个线性模型，通过训练得到一个线性回归方程。
# tf.estimator中也提供了线性回归的训练模型tf.estimator.LinearRegressor，
# 下面的代码就是使用LinearRegressor训练并评估模型的方法
